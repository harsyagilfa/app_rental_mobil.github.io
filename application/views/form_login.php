                  ...
                  <div class="col-xl-10 col-lg-12 col-md-9">
                        ...
                        <div class="card o-hidden border-0 shadow-lg my-5">
                              <div class="card-body p-0">
                                    ...
                                    <div class="row">
                                          <img src="<?= base_url('assets/upload/lambo.jpg') ?>" alt="" class="col-lg-7 d-none d-lg-block">
                                          <div class="col-lg-5">
                                                <div class="p-5">
                                                      ...
                                                      <?php if ($this->session->flashdata('flash')) : ?>
                                                            <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                                                  Username/Password <?= $this->session->flashdata('flash'); ?>
                                                      ...
                                                      <form action="<?= base_url('auth/login'); ?> " class="user" method="post">
                                                            <div class="form-group">
                                                                  ...
                                                                  <?= form_error('username', '<div class="text-danger text-ssmall">', '</div>'); ?>
                                                            </div>
                                                            <div class="form-group">
                                                      ...
                                                      <hr>
                                                      <div class="text-center">
                                                            <a class="small" href="<?= base_url('register'); ?>">Forgot Password?</a>
                                                      </div>
                                                      <div class="text-center">
