                  ...
                  <div class="col-xl-10 col-lg-12 col-md-9">
                        ...
                        <div class="card o-hidden border-0 shadow-lg my-5">
                              <div class="card-body p-0">
                                    ...
                                    <div class="row">
                                          <img src="<?= base_url('assets/upload/bugatti.jpg') ?>" alt="" class="col-lg-7 d-none d-lg-block">
                                          <div class="col-lg-5">
                                                <div class="p-5">
                                                      ...
                                                      <?php endif; ?>
                                                      <form action="<?= base_url('auth/ganti_password_aksi'); ?> " class="user" method="post">
                                                            <div class="form-group">
                                                                  <input id="pass_baru" type="password" class="form-control form-control-user" name="pass_baru" placeholder="password baru">
                                                                  <?= form_error('pass_baru', '<div class="text-danger text-small">', '</div>'); ?>
                                                            </div>
                                                            <div class="form-group">
                                                                  <input id="ulang_pass" type="password" class="form-control form-control-user" name="ulang_pass" placeholder="ulang Password">
                                                                  <?= form_error('ulang_pass', '<div class="text-danger text-small">', '</div>'); ?>
                                                            </div>
                                                            <button type="submit" class="btn btn-primary btn-user btn-block mt-3">Ganti Password</button>
                                                            <button type="reset" class="btn btn-success btn-user btn-block mt-3">Reset</button>
                                                      </form>
                                                </div>
                                          </div>
                                    </div>
