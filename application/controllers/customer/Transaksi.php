...
class Transaksi extends CI_Controller
{
      ...
      public function pembayaran_aksi()
      {
            ...
            $this->session->set_flashdata(
                  'flash',
                  ' <div class="alert alert-success alert-dismissible fade show" role="alert"> Bukti Pembayaran anda
                                                <strong>Berhasil Diupload</strong>
      ...
      public function batal_transaksi($id)
      {
            ...
            $this->session->set_flashdata(
                  'flash',
                  ' <div class="alert alert-success alert-dismissible fade show" role="alert"> Transaksi Berhasil
